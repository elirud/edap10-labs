...
class WashingProgram2 extends MessagingThread<WashingMessage> {
    ...
    public void run() {
        try {
            ...
            // Start the 15 minutes of prewashing in 40 degress
            ...
            // Prewash for 15 simulated minutes in 40 degrees(one minute == 60000 milliseconds)
            Thread.sleep(15 * 60000 / Wash.SPEEDUP);
            
            //Start the main wash for 30 minutes in 60 degrees
